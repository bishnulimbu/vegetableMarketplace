...
@section('content')
    ...
    <div class="grid gap-6 md:grid-cols-3 mb-10">
        <div class="rounded-2xl bg-white border border-green-100 p-6 card-hover">
            ...
            <h2 class="font-semibold text-lg mb-2">For Consumers</h2>
        ...
        <div class="rounded-2xl bg-white border border-green-100 p-6 card-hover">
            ...
            <h2 class="font-semibold text-lg mb-2">For Vendors</h2>
        ...
        <div class="rounded-2xl bg-white border border-green-100 p-6 card-hover">
            ...
            <h2 class="font-semibold text-lg mb-2">For Admins</h2>
