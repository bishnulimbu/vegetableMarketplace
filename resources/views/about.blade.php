...
@section('content')
    ...
    <div class="rounded-2xl bg-white border border-green-100 overflow-hidden mb-10">
        <div class="grid md:grid-cols-2">
            ...
            <div class="p-8 bg-rose-50">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">The Problem</h3>
                <ul class="space-y-3 text-slate-600">
                    <li class="flex items-start gap-3">
                        <span class="text-rose-500 mt-0.5">✕</span>
                        <span>Multiple layers of middlemen inflate vegetable prices by <strong>200–400%</strong></span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-rose-500 mt-0.5">✕</span>
                        <span>Farmers receive less than <strong>20%</strong> of what consumers pay</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-rose-500 mt-0.5">✕</span>
                        <span>Lack of transparency in pricing and sourcing</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-rose-500 mt-0.5">✕</span>
                        <span>Perishable produce goes to waste due to delayed market access</span>
                    </li>
                </ul>
            </div>
            {{-- The Solution --}}
            <div class="p-8 bg-green-50">
                <div class="text-4xl mb-4">📈</div>
                <h3 class="text-xl font-bold text-slate-900 mb-3">Our Solution</h3>
                <ul class="space-y-3 text-slate-600">
                    <li class="flex items-start gap-3">
                        <span class="text-green-600 mt-0.5">✓</span>
                        <span>Farmers list and sell <strong>directly</strong> to consumers</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-green-600 mt-0.5">✓</span>
                        <span>Farmers set their own fair prices — no intermediaries</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-green-600 mt-0.5">✓</span>
                        <span>Full transparency — see exactly which farm your food comes from</span>
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-green-600 mt-0.5">✓</span>
                        <span>Consumers get <strong>fresh, affordable</strong> produce straight from the source</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="rounded-2xl bg-white border border-green-100 p-8 mb-10">
        <h2 class="text-2xl font-bold text-slate-900 mb-8 text-center">How It Works</h2>
        <div class="grid gap-8 md:grid-cols-3">
            <div class="text-center">
                ...
                <h3 class="font-semibold text-lg mb-2">Farmers Register</h3>
                <p class="text-slate-500 text-sm">Farmers create an account and set up their digital storefront with their produce listings.</p>
            </div>
            <div class="text-center">
                <div class="w-16 h-16 rounded-full veg-gradient flex items-center justify-center text-white text-2xl mx-auto mb-4">2</div>
                <h3 class="font-semibold text-lg mb-2">Consumers Browse</h3>
                <p class="text-slate-500 text-sm">Consumers browse fresh vegetables, filter by condition or vendor, and add to cart.</p>
            </div>
            <div class="text-center">
                <div class="w-16 h-16 rounded-full veg-gradient flex items-center justify-center text-white text-2xl mx-auto mb-4">3</div>
                <h3 class="font-semibold text-lg mb-2">Direct Purchase</h3>
                <p class="text-slate-500 text-sm">Orders go directly to the farmer. No middlemen, no hidden markups — just fair trade.</p>
            </div>
        </div>
    </div>
    ...
    <div class="rounded-2xl veg-gradient p-8 md:p-12 text-center">
        <h2 class="text-3xl font-bold text-white mb-3">Ready to join the change?</h2>
        <p class="text-green-100 mb-6 max-w-xl mx-auto">Whether you're a farmer looking to sell directly or a consumer wanting fresh, fair-priced vegetables — Digital KrishiBazaar is for you.</p>
        <div class="flex flex-wrap gap-3 justify-center">
            ...
            <a href="{{ route('login') }}" class="inline-flex items-center gap-2 rounded-full bg-white/20 px-6 py-3 text-white font-medium hover:bg-white/30 transition backdrop-blur-sm">Log In</a>
        </div>
    </div>
@endsection
